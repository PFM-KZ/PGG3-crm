...
class EnveloSettlementWriteDataCommand extends Command
{
    /* @var EntityManager */
    private $em;
    ...
    {
        $this->setName('wecodersenergybundle:envelo-settlement-write-data')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $invoices = $this->em->getRepository('WecodersEnergyBundle:InvoiceSettlement')->findAll();
        ...
        $enveloOutputDir = $kernelRootDir . '/../var/data/envelo-settlement/' . $currentYear . '/' . $currentMonth;
        ...
        foreach ($clients as $itemData) {
            ...
            if ($enveloCounter == 39 || $index == $lastIterationIndex) { // Save and reset data
    ...
    {
        $relativeInvoicesPath = 'var/data/uploads/invoices-settlement-energy';
