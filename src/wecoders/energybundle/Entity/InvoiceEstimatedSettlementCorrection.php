...
/**
 * InvoiceEstimatedSettlementCorrection
 *
 * @ORM\Table(name="invoice_estimated_settlement_correction_energy")
 * @ORM\Entity(repositoryClass="Wecoders\EnergyBundle\Repository\InvoiceRepository")
 * @ORM\HasLifecycleCallbacks
 */
class InvoiceEstimatedSettlementCorrection extends InvoiceBase implements InvoiceInterface, IsDocumentReadyForBankAccountChangeInterface
{
    /**
     * @var array
     *
     ...
     * @param array $data
     *
     * @return InvoiceEstimatedSettlementCorrection
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Wecoders\EnergyBundle\Entity\InvoiceEstimatedSettlement", inversedBy="corrections")
