 ...
 */
class InvoiceSettlement extends InvoiceBase implements InvoiceInterface, ICollectiveMarkable, IsDocumentReadyForBankAccountChangeInterface, HasIncludedDocumentsInterface
{
    /**
     * @var array
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Wecoders\EnergyBundle\Entity\InvoiceSettlementCorrection", mappedBy="invoice", cascade={"persist","remove"}, orphanRemoval=true)
     */
    private $corrections;
