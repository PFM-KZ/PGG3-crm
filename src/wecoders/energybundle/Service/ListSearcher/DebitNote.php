...
class DebitNote extends ListSearcher implements EntityListSearcherInterface
{
    private $entity = 'Wecoders\EnergyBundle\Entity\DebitNote';

    protected $exporterTableName = 'debitNote';

    private $twigTemplate = '@WecodersEnergyBundle/default/parts/listSearch/debit-note.html.twig';
