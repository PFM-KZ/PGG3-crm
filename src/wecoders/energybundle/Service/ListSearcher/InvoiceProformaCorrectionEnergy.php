...
class InvoiceProformaCorrectionEnergy extends ListSearcher implements EntityListSearcherInterface, ListFilesDownloaderInterface
{
    const ROOT_RELATIVE_INVOICES_NEW_VERSION_PATH = 'var/data/uploads/invoices-proforma-correction-energy/';

    private $entity = 'Wecoders\EnergyBundle\Entity\InvoiceProformaCorrection';

    protected $exporterTableName = 'invoiceProformaCorrectionEnergy';
