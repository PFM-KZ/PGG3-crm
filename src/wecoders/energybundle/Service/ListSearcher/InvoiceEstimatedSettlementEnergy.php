...
class InvoiceEstimatedSettlementEnergy extends ListSearcher implements EntityListSearcherInterface, ListFilesDownloaderInterface
{
    const ROOT_RELATIVE_INVOICES_NEW_VERSION_PATH = 'var/data/uploads/invoices-estimated-settlement-energy/';

    private $entity = 'Wecoders\EnergyBundle\Entity\InvoiceEstimatedSettlement';

    protected $exporterTableName = 'invoiceEstimatedSettlementEnergy';
