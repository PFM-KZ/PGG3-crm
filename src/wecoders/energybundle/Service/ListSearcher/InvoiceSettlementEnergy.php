...
class InvoiceSettlementEnergy extends ListSearcher implements EntityListSearcherInterface, ListFilesDownloaderInterface
{
    const ROOT_RELATIVE_INVOICES_NEW_VERSION_PATH = 'var/data/uploads/invoices-settlement-energy/';

    private $entity = 'Wecoders\EnergyBundle\Entity\InvoiceSettlement';

    protected $exporterTableName = 'invoiceSettlementEnergy';
