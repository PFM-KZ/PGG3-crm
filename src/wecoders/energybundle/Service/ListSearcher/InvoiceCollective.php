...
class InvoiceCollective extends ListSearcher implements EntityListSearcherInterface, ListFilesDownloaderInterface
{
    const ROOT_RELATIVE_INVOICES_NEW_VERSION_PATH = 'var/data/uploads/invoices-collective/';

    private $entity = 'Wecoders\EnergyBundle\Entity\InvoiceCollective';

    protected $exporterTableName = 'InvoiceCollective';
