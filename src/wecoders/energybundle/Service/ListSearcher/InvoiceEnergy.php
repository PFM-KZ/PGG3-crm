...
class InvoiceEnergy extends ListSearcher implements EntityListSearcherInterface, ListFilesDownloaderInterface
{
    const ROOT_RELATIVE_INVOICES_NEW_VERSION_PATH = 'var/data/uploads/invoices-energy/';

    private $entity = 'Wecoders\EnergyBundle\Entity\Invoice';

    protected $exporterTableName = 'invoiceEnergy';
