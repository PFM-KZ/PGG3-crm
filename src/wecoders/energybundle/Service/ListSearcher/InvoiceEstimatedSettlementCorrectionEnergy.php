...
class InvoiceEstimatedSettlementCorrectionEnergy extends ListSearcher implements EntityListSearcherInterface, ListFilesDownloaderInterface
{
    const ROOT_RELATIVE_INVOICES_NEW_VERSION_PATH = 'var/data/uploads/invoices-estimated-settlement-correction-energy/';

    private $entity = 'Wecoders\EnergyBundle\Entity\InvoiceEstimatedSettlementCorrection';

    protected $exporterTableName = 'invoiceEstimatedSettlementCorrectionEnergy';
    ...
    public function addParameters(QueryBuilder $queryBuilder, Request $request)
    {
        ...
        // Not implemented in Invoice yet
