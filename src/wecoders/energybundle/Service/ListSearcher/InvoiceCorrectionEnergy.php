...
class InvoiceCorrectionEnergy extends ListSearcher implements EntityListSearcherInterface, ListFilesDownloaderInterface
{
    const ROOT_RELATIVE_INVOICES_NEW_VERSION_PATH = 'var/data/uploads/invoices-correction-energy/';

    private $entity = 'Wecoders\EnergyBundle\Entity\InvoiceCorrection';

    protected $exporterTableName = 'invoiceCorrectionEnergy';
