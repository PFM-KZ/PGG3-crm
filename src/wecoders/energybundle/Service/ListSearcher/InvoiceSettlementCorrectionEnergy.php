...
class InvoiceSettlementCorrectionEnergy extends ListSearcher implements EntityListSearcherInterface, ListFilesDownloaderInterface
{
    const ROOT_RELATIVE_INVOICES_NEW_VERSION_PATH = 'var/data/uploads/invoices-settlement-correction-energy/';

    private $entity = 'Wecoders\EnergyBundle\Entity\InvoiceSettlementCorrection';

    protected $exporterTableName = 'invoiceSettlementCorrectionEnergy';
