...
class GasPSGGdanskV2 extends Energy implements ImporterStrategyInterface
{
    protected $uploadDirectory = 'var/data/wecoders/energybundle/data/gas/psg-gdansk-v2';
    protected $code = OsdModel::OPTION_GAS_PSG_GDANSK_V2;
    protected $value = 'Gaz - PSG Gdańsk od 2020 (nowy format)';
