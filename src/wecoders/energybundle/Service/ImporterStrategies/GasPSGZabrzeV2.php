...
class GasPSGZabrzeV2 extends Energy implements ImporterStrategyInterface
{
    protected $uploadDirectory = 'var/data/wecoders/energybundle/data/gas/zabrze-v2';
    protected $code = OsdModel::OPTION_GAS_PSG_ZABRZE_V2;
    protected $value = 'Gaz - PSG Zabrze od 2020 (nowy format)';
