...
class GasPSGWarszawaV2 extends Energy implements ImporterStrategyInterface
{
    protected $uploadDirectory = 'var/data/wecoders/energybundle/data/gas/warszawa-v2';
    protected $code = OsdModel::OPTION_GAS_PSG_WARSZAWA_V2;
    protected $value = 'Gaz - PSG Warszawa od 2020 (nowy format)';
