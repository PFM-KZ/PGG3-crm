...
class GasPSGTarnowV2 extends Energy implements ImporterStrategyInterface
{
    protected $uploadDirectory = 'var/data/wecoders/energybundle/data/gas/tarnow-v2';
    protected $code = OsdModel::OPTION_GAS_PSG_TARNOW_V2;
    protected $value = 'Gaz - PSG Tarnów od 2020 (nowy format)';
