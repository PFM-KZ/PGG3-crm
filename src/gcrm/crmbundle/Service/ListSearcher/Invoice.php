...
class Invoice extends ListSearcher implements EntityListSearcherInterface, ListFilesDownloaderInterface
{
    const ROOT_RELATIVE_INVOICES_NEW_VERSION_PATH = 'var/data/uploads/invoices-new-version/';

    private $entity = 'GCRM\CRMBundle\Entity\Invoice';

    protected $exporterTableName = 'invoice';
