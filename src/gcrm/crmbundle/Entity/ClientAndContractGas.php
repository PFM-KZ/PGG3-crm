...
/**
 * ClientAndContractGas
 *
 * @ORM\Table(name="link_client_and_contract_gas")
 * @ORM\Entity(repositoryClass="GCRM\CRMBundle\Repository\ClientAndContractRepository")
 * @ORM\HasLifecycleCallbacks
 */
class ClientAndContractGas implements ClientAndContractInterface
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="GCRM\CRMBundle\Entity\Client", inversedBy="clientAndGasContracts")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="GCRM\CRMBundle\Entity\ContractGas", fetch="EAGER")
