...
/**
 * ContractGasAndSellerTariff
 *
 * @ORM\Table(name="contract_gas_and_seller_tariff")
 * @ORM\Entity(repositoryClass="GCRM\CRMBundle\Repository\ContractRepositoryRepository")
 * @ORM\HasLifecycleCallbacks
 */
class ContractGasAndSellerTariff
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="GCRM\CRMBundle\Entity\ContractGas", inversedBy="contractAndSellerTariffs")
