...
/**
 * ContractEnergyAndSellerTariff
 *
 * @ORM\Table(name="contract_energy_and_seller_tariff")
 * @ORM\Entity(repositoryClass="GCRM\CRMBundle\Repository\ContractRepositoryRepository")
 * @ORM\HasLifecycleCallbacks
 */
class ContractEnergyAndSellerTariff
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="GCRM\CRMBundle\Entity\ContractEnergy", inversedBy="contractAndSellerTariffs")
