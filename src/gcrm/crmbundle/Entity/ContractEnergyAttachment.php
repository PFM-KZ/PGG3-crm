 ...
 * ContractAttachment
 *
 * @ORM\Table(name="contract_energy_attachment")
 * @Vich\Uploadable
 * @ORM\Entity(repositoryClass="GCRM\CRMBundle\Repository\ContractEnergyAttachmentRepository")
 * @ORM\HasLifecycleCallbacks
 */
class ContractEnergyAttachment
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="GCRM\CRMBundle\Entity\ContractEnergy", inversedBy="contractAttachments")
     ...
     * @var File
     *
     * @Vich\UploadableField(mapping="contractsEnergyPrivate", fileNameProperty="urlFileTemp")
     */
    private $urlFile;
