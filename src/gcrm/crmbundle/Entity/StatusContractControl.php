 ...
 *
 * @ORM\Table(name="status_contract_control")
 * @ORM\Entity(repositoryClass="GCRM\CRMBundle\Repository\StatusContractControlRepository")
 */
class StatusContractControl
{
    /**
     * @var int
     *
