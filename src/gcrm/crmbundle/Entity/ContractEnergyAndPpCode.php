...
/**
 * ContractEnergyAndPpCode
 *
 * @ORM\Table(name="contract_energy_and_pp_code")
 * @ORM\Entity()
 * @ORM\HasLifecycleCallbacks
 */
class ContractEnergyAndPpCode
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="GCRM\CRMBundle\Entity\ContractEnergy", inversedBy="contractAndPpCodes")
