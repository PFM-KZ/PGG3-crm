...
/**
 * RecordingGasAttachment
 *
 * @ORM\Table(name="recording_gas_attachment")
 * @Vich\Uploadable
 * @ORM\Entity(repositoryClass="GCRM\CRMBundle\Repository\RecordingGasAttachmentRepository")
 * @ORM\HasLifecycleCallbacks
 */
class RecordingGasAttachment
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="GCRM\CRMBundle\Entity\ContractGas", inversedBy="recordingAttachments")
     ...
     * @var File
     *
     * @Vich\UploadableField(mapping="recordingsGasPrivate", fileNameProperty="urlFileTemp")
     */
    private $urlFile;
