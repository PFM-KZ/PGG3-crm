 ...
 *
 * @ORM\Table(name="status_contract_authorization")
 * @ORM\Entity(repositoryClass="GCRM\CRMBundle\Repository\StatusContractAuthorizationRepository")
 */
class StatusContractAuthorization
{
    /**
     * @var int
     *
     ...
     * @param string $title
     *
     * @return StatusContractAuthorization
     */
