 ...
 *
 * @ORM\Table(name="status_contract_administration")
 * @ORM\Entity(repositoryClass="GCRM\CRMBundle\Repository\StatusContractAdministrationRepository")
 */
class StatusContractAdministration
{
    /**
     * @var int
     *
     ...
     * @param string $title
     *
     * @return StatusContractAdministration
     */
